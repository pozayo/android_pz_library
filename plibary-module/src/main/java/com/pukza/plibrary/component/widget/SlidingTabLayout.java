...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    /**
     * Set the custom {@link widget.google.samples.apps.iosched.ui.widget.SlidingTabLayout.TabColorizer} to be used.
     *
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link widget.google.samples.apps.iosched.ui.widget.SlidingTabLayout} you are
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mDistributeEvenly) {
                ...
                lp.width = 0;
                if(mWeight != null && i < mWeight.length)
                {
                    lp.weight = mWeight[i];
                }else{
                    lp.weight = 1;
    ...
    {
    	if(mTabStrip != null)
    		mTabStrip.setUnderline(isUnderline);
    }
